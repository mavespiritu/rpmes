  ...
  <span class="label label-success">'.$sNum ->rowCount().' saved project</span>';
     ...
     <li class="active" ><a href="?page=485a993995bd218607c3ffe78bc387fafeaf7e5a&Panel=4ea9fa7240ef926ed7106723775a2ed1edd66fad&project=6d7f200fac43f37f5b196bdc0152d9e56541c7f3" 
    ...
    <div class="form-group hide-print  ">
          <div class="col-sm-2">
             ...
             $locations = new locationDAO();
                $resultLocations =$locations->getList(); 
...
<script>
function printMe(){
  //  document.getElementById("reduceSpan").colSpan = 4;
    window.print();
...
$main = new monitoringplan();
    $main->displayListInTable();
class monitoringplan {
    ...
    function displayListInTable(){
      ...
      if(isset($_GET['agencysmrtbl'])){
        ...
        $result =     $plan->getList($fundsrc , $year, $smrySect, $locationss, $agencysmrtbl);
...
';
            if($auth->is_admin()=="true"){
           echo ' <td class="hide-print tg-yw4l" >
...
<input  name="projid" id="projid" class="form-control hideElement " readonly />
     ...
     <div class="form-group">
        ...
        if($auth->is_admin()=='true'){
                ...
                $result =$agency->getList(); 
                 echo '<label for="agency" onfocus="setCustomValidity("")" class="col-sm-2 control-label">Agency</label>
   

                     <div class="col-sm-4">
                     <select required="required" id="agency" name="agency" class="form-control">';
  ...
  <label for="period" class="col-sm-2 control-label">Period</label>
     ...
     <div class="form-group">
        ...
        <div class="col-sm-4 ">
              ...
              <?php
                ...
                $prRes=$pr->getPrograms(); 
                 ...
                 echo '<select onfocus="setCustomValidity("")"  id="programnameCB" name="programnameCB" class="form-control ">';
      ...
      <input  type="text" disabled  name="programname" onfocus="setCustomValidity('')" class=" form-control"
...
<select  id="ssubsector" onfocus="setCustomValidity('')"  name="subsector" class="form-control">';
    ...
    <div class="col-sm-4">
        ...
        <?php
                ...
                $resultFundSrc =$fundsrc->getList(); 
                 echo '<select required="required" id="fundsrc" onfocus="setCustomValidity("")"  name="fundsrc" class="form-control">';
  ...
  <div class="col-sm-10">
      ...
      <input required="required" type="number"  step="0.001" 
              name="fq3" id="fq3" 
             onfocus="setCustomValidity('')" 
             class="form-control" placeholder="Quarter 3"/>
      ...
      <div class="modal-body" >
          ...
          <div class="form-group">
              ...
              <div class="row">
                  ...
                  <div class="col-sm-3"><b>Employment Generated</b></div>
              </div>
              <div class="row">
                  ...
                  <div class="col-sm-3"> <h5 id="twdq1"></h5></div>
              ...
              <div class="row">
                  ...
                  <div class="col-sm-3"> <h5 id="twdq2"></h5></div>
              ...
              <div class="row">
                  ...
                  <div class="col-sm-3"> <h5 id="twdq3"></h5></div>
              ...
              <div class="row">
                  ...
                  <div class="col-sm-3"> <h5 id="twdq4"></h5></div>
