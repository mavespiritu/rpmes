...
<div class="title-footer-print">
    ...
    <h1 style="font-size:11pt; padding: 0px; margin:0px;" align="center">RPMES Form 8: Report on the Problem Solving Session/Facilitation Meeting</h1>
...
<table id="tblOverFlow" class="tg accReport table saveExcel ">
 <thead>
  ...
  <tr>
    ...
    <th class="tg-amwm noBorderbottom" >Implementing Agency</th>
    <th class="tg-amwm noBorderbottom" >Date of PSS</th>
    
    <th class="tg-amwm noBorderbottom">Concerned Entities</th>
    <th class="tg-amwm noBorderbottom">Agreements Reached</th>
    <th class="tg-amwm noBorderbottom">Next Steps</th>
 ...
 <tbody class="tody">
    ...
    $ctr = 1;
      $result = $acc->getFrm8($quarterG,$fundSrcOpt, $agencysmrtbl, $locationss, $smrySect, $yrenroll);
 
      while($data =  $result->fetch(PDO::FETCH_OBJ)){
         
echo '<tr>
    <td class="tg-yw4l"  style="width:200px;">'.$ctr.".) ".$data->projname.'</td>
    <td class="tg-yw4l" style="width:80px;" >'.$data->location.'</td>
    <td class="tg-yw4l" style="width:40px;">'.$data->implementingAgency.'</td>
    <td class="tg-yw4l" style="width:40px;">'.$data->dateOfPSS.'</td>
    <td class="tg-yw4l" style="width:40px;" >'.$data->concernedAgencies.'</td>
    <td class="tg-yw4l" style="width:200px;">'.$data->agreementsReached.'</td>
    <td class="tg-yw4l" style="width:200px;">'.$data->nexSteps.'</td>
        </tr>
';
